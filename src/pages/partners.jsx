...
const Partners = () => {
  return (
    <div className="container mx-auto p-4 py-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {partners.map((partner, index) => (
          <div key={index} className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mt-2">{partner.location}</p>
          </div>
        ))}
      </div>

      <h1 className="text-3xl font-bold mt-12 mb-8">Our Supporters</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <h1 className="text-3xl font-bold mt-12 mb-8 -z-20">Supporters Map</h1>
